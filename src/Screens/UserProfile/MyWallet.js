      ...
      <ScrollView
        ...
        <View style={styles.sectionContainer}>
          ...
          <Text style={styles.text}>
            Any vote or action you do on the app will be logged securely on the
            blockchain. This promises that the common activity is truely
        ...
        <View style={styles.sectionContainer}>
          ...
          <Text style={styles.text}>
            if you get money you’ll find it here. Otherwise there’s not much to
            do with this wallet (just like any other wallet).
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
