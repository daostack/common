...
const EditProfile = ({rootStore, route, navigation}: Props): ReactElement => {
  ...
  return (
    ...
    onSubmit={formSave}
    >
    {({handleChange, handleBlur, values, errors, touched, handleSubmit}): ReactElement => {
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        {authStore.userInfo ? ( <View style={styles.body}>
         <View
        style={{
          alignSelf: 'stretch',
          flexGrow: 1,
        ...
        <View style={styles.containerRow}>
            <TouchableOpacity
              ...
              <Text style={text.buttonblue}>{route.params.isFirstOpening ? 'Skip' : 'Cancel'}</Text>
            </TouchableOpacity>
