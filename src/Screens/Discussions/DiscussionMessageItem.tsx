...
const DiscussionMessageItem: React.FC<{
...
}> = ({data, commonId, openMessageOptions, isMember, viewerPermission}) => {
  ...
  const isOwner = getCurrentUser()?.uid === data.ownerId;
...
export default inject('rootStore')(observer(DiscussionMessageItem));
