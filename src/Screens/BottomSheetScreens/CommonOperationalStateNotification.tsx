...
export interface CommonOperationalStateNotificationProps {
  onCreateFundingProposal(): void;
}

export const CommonOperationalStateNotification: React.FC<CommonOperationalStateNotificationProps> = ({
