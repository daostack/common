...
import {FormStore} from '~/Stores/FormStores';

const {width} = Dimensions.get('window');

const RequestStepActionButton: React.FC<{
  onPress(): void;
  title: string;
  isSticky?: boolean;
  hidden?: boolean;
  pass?: boolean;
  formStore: FormStore;
}> = ({hidden, pass, formStore, onPress, title, isSticky = true}) => {
  ...
  if (!isSticky) {
    ...
    actionBtnStyle = {...actionBtnStyle, ...styles.stickyStyle};
  }
