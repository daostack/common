...
export const graphHttpLink = 'https://api.thegraph.com/subgraphs/name/daostack/v7_5_exp_rinkeby';
export const graphwsLink = 'wss://api.thegraph.com/subgraphs/name/daostack/v7_5_exp_rinkeby';
